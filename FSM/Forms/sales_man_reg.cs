...
namespace FSM
{
    public partial class sales_man_reg : Form
    {
        MySqlConnection conn = null;
        string base64String = "";

        public sales_man_reg()
        {
            InitializeComponent();
        ...
        private void btn_delete_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                {
                    MySqlCommand dass = new MySqlCommand("Delete from fsm_sales_man_reg where ID='" + txt_id.Text + "'", conn);
        ...
        private void Sve()
        {
            ...
            //try
            {
                ...
                MySqlCommand itd = new MySqlCommand("INSERT INTO `fsm_sales_man_reg`( `fname`, `lname`, `comp_name`, `email`, `phno`, `mobno`, `contry`, `city`, `street`, `house`, `image`, `branch`, `user_name`, `pc_name`, `ip`, `date`, `time`) VALUES ('" + txt_fname.Text + "','" + txt_lname.Text + "','" + txt_comp_name.Text + "','" + tex_email.Text + "','" + txt_ph_no.Text + "','" + tex_mob.Text + "','" + cb_contry.Text + "','" + cb_city.Text + "','" + txt_street_no.Text + "','" + txt_house_no.Text + "','" + base64String + "','" + branchescombobox.Text + "','"+Login.user_n+"','" + system_name + "','" + GetIPAddress() + "','" + addingDateTimeStamp() + "','" + addingTimeNow() + "')", conn);
                itd.ExecuteNonQuery();
                itd.Dispose();
        ...
        private void lview()
        {
            ...
            MySqlDataAdapter rrx = new MySqlDataAdapter("select ID,fname,email,phno,comp_name,contry from fsm_sales_man_reg where(branch='" + Login.branch + "')", conn);
        ...
        private void listView1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                pictureBox2.Image = null;
                MySqlCommand sel = new MySqlCommand("select fname,lname,email,phno,comp_name,mobno,contry,city,street,house,image,branch from fsm_sales_man_reg where ID='" + txt_id.Text + "'", conn);
                sel.ExecuteNonQuery();
