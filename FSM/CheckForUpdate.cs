...
namespace FSM
{
    ...
    {
        //"http://themech.net/downloads/update_example.xml";
        private static string xmlFileUrl = "http://wabwar.com/version/update_example.xml";
        private readonly update_check mainApp;
        Thread m_WorkerThread;
        readonly ManualResetEvent m_EventStopThread;
        readonly ManualResetEvent m_EventThreadStopped;
        
        public CheckForUpdate(update_check mainApp)
        {
        ...
        private void CheckForUpdateFunction()
        {
            ...
            try
            {
                ...
                st_dow.lblupdatestatus.Text = "Downloading is in Progress, Please wait..";
                st_dow.lblupdatestatus.Update();
